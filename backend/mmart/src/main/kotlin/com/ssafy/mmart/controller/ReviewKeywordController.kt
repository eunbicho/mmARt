...
class ReviewKeywordController @Autowired constructor(
    ...
    @PostMapping
    fun createReviewKeyword(@RequestBody reviewKeywordReq: ReviewKeywordReq): ResultResponse<List<ReviewKeywordRes>?> {
        return ResultResponse.success(reviewKeywordService.createReviewKeyword(reviewKeywordReq))
    }
